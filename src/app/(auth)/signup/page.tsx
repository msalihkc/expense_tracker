    ...
    return (
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 p-8 pt-10 animate-in fade-in zoom-in duration-500">
            <div className="flex flex-col items-center mb-8">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-center text-sm">Start tracking your expenses today</p>
            </div>
            ...
            <form action={formAction} className="space-y-4">
                ...
                <button
                    disabled={pending}
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-lg transition-colors mt-4 focus:ring-4 focus:ring-blue-500/20 outline-none disabled:opacity-50 disabled:cursor-not-allowed">
